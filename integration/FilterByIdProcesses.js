...
var FilterByIdProcesses = function(db, id){
	...
	this.id = id;
	if(!id){
		logger.error("integration/FilterByIdProcess# constructor, no ID provided");
	}
	logger.info("integration/FilterByIdProcess# constructor, constructed with id,", this.id);
};
...
FilterByIdProcesses.prototype.all = function() { // all of the one
	...
	return new Promise(function(resolve, reject){
		logger.trace("integration/FilterByIdProcess# all(), new Promise"); ///
