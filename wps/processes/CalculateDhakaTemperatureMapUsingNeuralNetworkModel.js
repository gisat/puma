...
class CalculateDhakaTemperatureMapUsingNeuralNetworkModel extends WpsBaseProcess {
	constructor(pgPool, pantherTemporaryStoragePath, pantherDataStoragePath, pgSchema, mongo) {
		...
		this._describe = {
			identifier: `CalculateDhakaTemperatureMapUsingNeuralNetworkModel`,
			title: `CalculateDhakaTemperatureMapUsingNeuralNetworkModel`,
			abstract: `Calculate temperature map for Dhaka using neural network model by VITO`,
			inputs: {
				inputFile: {
		...
		this._pucsMatlabProcessor = new PucsMatlabProcessor(`dhaka`, `/home/mbabic/matlab_ua_dhaka`, `/usr/local/MATLAB/MATLAB_Runtime/v901`, pgPool, pgSchema, mongo);
...
CalculateDhakaTemperatureMapUsingNeuralNetworkModel.prototype.name = 'CalculateDhakaTemperatureMapUsingNeuralNetworkModel';

module.exports = CalculateDhakaTemperatureMapUsingNeuralNetworkModel;